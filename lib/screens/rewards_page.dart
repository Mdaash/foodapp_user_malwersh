...
class _RewardsPageState extends State<RewardsPage>
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              Text(
                '${(_targetPoints - currentPoints).clamp(0, _targetPoints)} نقطة',
                style: const TextStyle(
                  color: Colors.white,
                  fontSize: 12,
                  fontWeight: FontWeight.bold,
  ...
  // إصلاح الشريط الأصفر وإضافة التنقل لشاشة القسائم
        ...
        child: Container(
          ...
          child: Column(
            children: [
              ...
              // Expanded with SingleChildScrollView - هذا يحل مشكلة الشريط الأصفر
              Expanded(
