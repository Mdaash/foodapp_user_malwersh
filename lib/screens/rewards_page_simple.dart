                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text(
                        'هل تريد استبدال ${reward['points']} نقطة للحصول على المكافأة التالية؟',
                        textAlign: TextAlign.center,
                        style: const TextStyle(
                          fontSize: 16,
                          color: Colors.grey,
                        ...
                        children: [
                          SizedBox(
                            ...
                            child: ElevatedButton(
                              onPressed: () {
                                Navigator.pop(context);
                                // التنقل لشاشة القسائم باستخدام Navigator.push
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
